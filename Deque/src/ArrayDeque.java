...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        if (data == null) {
            ...
            for (int i = 0; i < size; i++) {
                copyArray[i + 1] = backingArray[mod((front + i), backingArray.length)];
            }
            copyArray[0] = data;
            front = 0;
    ...
    public void addLast(T data) {
        if (data == null) {
            ...
            T[] copyArray = (T[]) new Object[size * 2];
            for (int i = 0; i < size; i++) {
                copyArray[i] = backingArray[mod((front + i), backingArray.length)];
            }
            front = 0;
            backingArray = copyArray;
        }
    ...
    public T removeLast() {
        ...
        T dataRemoved = backingArray[mod((front + size - 1), backingArray.length)];
